...
data.thinkerProfiles = {
  ...
  'Friedrich Nietzsche': 'Friedrich Nietzsche questionou valores herdados, moralidade e conformismo. Seus aforismos relacionam criação de si, conflito interior e afirmação da vida sem oferecer consolo fácil.',
  'Píndaro e Friedrich Nietzsche': 'A formulação reúne uma máxima de Píndaro e sua retomada por Nietzsche. O vínculo entre os dois deve ser lido como linhagem filosófica documentada, não como autoria conjunta de uma mesma frase.',
  'François de La Rochefoucauld': 'La Rochefoucauld foi um moralista francês conhecido por máximas sobre amor-próprio, interesse, vaidade e autoengano. Sua escrita breve investiga motivos que nem sempre reconhecemos em nós mesmos.',
  'Albert Camus': 'Albert Camus foi escritor e ensaísta franco-argelino. Sua obra enfrenta absurdo, revolta, medida e pertencimento ao mundo sem reduzir a existência a uma resposta definitiva.',
  'Buda / Dhammapada': 'O Dhammapada reúne versos da tradição budista atribuídos aos ensinamentos do Buda. Eles relacionam mente, ação, apego e sofrimento, sem constituir uma obra de autoria individual moderna.',
  'Emily Dickinson': 'Emily Dickinson foi uma poeta norte-americana cuja escrita concentra morte, ausência, esperança e vida interior em imagens breves, precisas e frequentemente paradoxais.',
  'Khalil Gibran': 'Khalil Gibran foi poeta e ensaísta libanês-americano. Sua obra pensa amor, liberdade e vínculo por meio de uma linguagem espiritual e poética, sem confundir afeto com posse.',
  'Mary Oliver': 'Mary Oliver foi uma poeta norte-americana. Sua escrita aproxima atenção à natureza, espanto e finitude, encontrando no mundo concreto perguntas sobre como viver.',
  'C. S. Lewis': 'C. S. Lewis foi escritor e ensaísta britânico. Em seus textos sobre perda, especialmente os de caráter autobiográfico, examinou o luto sem esconder desorientação, raiva e dúvida.',
  'Joan Didion': 'Joan Didion foi escritora e ensaísta norte-americana. Ao escrever sobre a morte e o luto, observou com precisão como a perda altera memória, rotina e percepção da realidade.',
  'Mia Couto': 'Mia Couto é um escritor moçambicano cuja linguagem reinventa imagens para tratar memória, identidade, perda e pertencimento. Sua prosa poética aproxima experiência íntima e mundo coletivo.',
  Epicuro: 'Epicuro foi um filósofo grego que relacionou serenidade à compreensão dos desejos, à amizade e à libertação de medos desnecessários, inclusive o medo da morte.',
  'Oscar Wilde': 'Oscar Wilde foi escritor e dramaturgo irlandês. Sua obra usa paradoxo, ironia e beleza para expor convenções sociais, aparência, desejo e contradições morais.',
  'Nelson Rodrigues': 'Nelson Rodrigues foi dramaturgo, jornalista e cronista brasileiro. Sua escrita expõe desejo, ciúme, culpa e hipocrisia familiar por meio de uma linguagem deliberadamente provocadora.',
  'Ramana Maharshi': 'Ramana Maharshi foi um mestre indiano ligado à tradição não dual. Seu ensinamento utiliza a investigação “quem sou eu?” para examinar a identificação com pensamentos e imagens do eu.',
  'Anandamayi Ma': 'Anandamayi Ma foi uma mestra espiritual indiana. Seus ensinamentos enfatizam presença, devoção e reconhecimento de uma dimensão interior que não se reduz às oscilações da mente.',
  Mirabai: 'Mirabai foi uma poeta devocional indiana associada à tradição bhakti. Seus poemas apresentam amor, ausência e entrega como relação intensa com o divino.',
  'Lev Shestov': 'Lev Shestov foi um filósofo existencial russo. Sua obra confronta a pretensão de que razão e sistemas possam eliminar a incerteza, o desespero e o inesperado da existência.',
  'Miguel de Unamuno': 'Miguel de Unamuno foi escritor e filósofo espanhol. Pensou a tensão entre razão, fé, desejo de permanência e consciência da morte sem resolvê-la em uma síntese confortável.',
  'Gabor Maté': 'Gabor Maté é médico e autor conhecido por relacionar sofrimento, estresse, vínculo e contexto social. Seu trabalho procura compreender comportamentos sem reduzi-los a falha moral.',
  'Ailton Krenak': 'Ailton Krenak é escritor, pensador e liderança indígena brasileira do povo Krenak. Sua obra questiona a separação entre humanidade e natureza e critica ideias estreitas de progresso.',
  'Bayo Akomolafe': 'Bayo Akomolafe é ensaísta e pensador nigeriano. Seu trabalho aproxima cosmologias iorubás, pensamento pós-humanista e crise civilizatória para questionar respostas rápidas e caminhos únicos.',
  'Malidoma Somé': 'Malidoma Patrice Somé foi autor e ancião iniciado do povo Dagara, de Burkina Faso. Sua obra relaciona comunidade, ancestralidade, natureza e ritual na elaboração coletiva da experiência.',
  'bell hooks': 'bell hooks foi escritora, professora e crítica cultural norte-americana. Sua obra pensa amor, educação e dominação como questões éticas e políticas, ligando intimidade e transformação social.',
  'Hélène Cixous': 'Hélène Cixous é escritora e pensadora franco-argelina ligada à crítica feminista e à desconstrução. Sua obra investiga corpo, diferença, exílio e liberdade por meio da própria escrita.',
  'Luce Irigaray': 'Luce Irigaray é filósofa e teórica feminista. Seu trabalho examina linguagem, alteridade e diferença sexual, questionando modelos que transformam o outro em simples reflexo do mesmo.',
  Dogen: 'Dōgen foi um mestre zen japonês e fundador da escola Sōtō no Japão. Seus escritos relacionam prática, tempo e impermanência, recusando separar completamente caminho e realização.',
  'Ikkyu Sojun': 'Ikkyū Sōjun foi um monge e poeta zen japonês conhecido por criticar formalismo e hipocrisia religiosa. Sua poesia reúne disciplina espiritual, desejo, morte e vida cotidiana.',
  'Richard Dawkins': 'Richard Dawkins é biólogo e divulgador científico britânico. Sua obra explica evolução e seleção natural; quando inspira uma reflexão editorial, isso não transforma a adaptação em citação literal.',
  'Søren Kierkegaard': 'Søren Kierkegaard foi um filósofo dinamarquês. Sua obra investiga angústia, escolha, desespero e a tarefa de tornar-se si mesmo diante de decisões que não podem ser terceirizadas.',
  'Rubem Alves': 'Rubem Alves foi escritor, educador e psicanalista brasileiro. Seus ensaios utilizam imagens poéticas para pensar desejo, medo, educação, liberdade e a coragem de deixar espaços conhecidos.',
};
