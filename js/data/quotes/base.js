  ...
  batches.base = [
{
  ...
  },
  {
    ...
    sentimentos: ['autoconhecimento', 'falta_de_proposito'], intensidade: ['moderada'], temas: ['autoconhecimento', 'isolamento', 'crescimento'], tom: 'poético', profundidade: 5,
  ...
  {
    id: 'curated-06', editorialStatus: 'quarantine', autor: 'Epicteto', frase: 'A solidão pode ser prisão ou espaço de liberdade; a diferença está no uso que fazemos dela.',
  ...
  },
  {
    ...
    sentimentos: ['amor'], intensidade: ['moderada'], temas: ['intimidade', 'confiança', 'entrega'], tom: 'poético', profundidade: 4,
  ...
  },
  {
    ...
    sentimentos: ['raiva', 'confusão'], intensidade: ['moderada'], temas: ['virtude', 'temperança', 'justiça'], tom: 'direto', profundidade: 4,
  ...
  {
    id: 'curated-10', editorialStatus: 'quarantine', autor: 'Carl Jung', frase: 'Aquilo que nos irrita nos outros pode ajudar a compreender melhor a nós mesmos.',
  ...
  {
    id: 'curated-11', editorialStatus: 'quarantine', autor: 'Hannah Arendt', frase: 'O perdão interrompe consequências que, sem ele, continuariam se repetindo indefinidamente.',
  ...
  {
    id: 'curated-12', editorialStatus: 'quarantine', autor: 'Marco Aurélio', frase: 'A qualidade dos pensamentos que você alimenta influencia a qualidade da vida que percebe e constrói.',
  ...
  {
    id: 'curated-13', editorialStatus: 'quarantine', autor: 'John Keats', frase: 'Maturidade também é conseguir permanecer entre incertezas e dúvidas sem exigir uma resposta imediata.',
  ...
  {
    id: 'curated-14', editorialStatus: 'quarantine', autor: 'Nelson Mandela', frase: 'Coragem não é ausência de medo, mas a decisão de agir apesar dele.',
  ...
  {
    id: 'curated-15', editorialStatus: 'quarantine', autor: 'Rumi', frase: 'Uma ferida reconhecida pode se tornar o lugar por onde começa a cura.',
  ...
  {
    id: 'curated-16', editorialStatus: 'quarantine', autor: 'Lao-Tsé', frase: 'A ansiedade cresce quando a mente abandona o presente para tentar controlar o futuro.',
  ...
  {
    id: 'curated-18', editorialStatus: 'quarantine', autor: 'Sêneca', frase: 'A raiva prolongada costuma ferir primeiro a pessoa que continua alimentando-a.',
  ...
  {
    id: 'curated-19', editorialStatus: 'quarantine', autor: 'Viktor Frankl', frase: 'Quando não podemos mudar uma situação, somos desafiados a mudar nossa maneira de responder a ela.',
  ...
  },
  {
    ...
    sentimentos: ['confusão'], intensidade: ['moderada'], temas: ['mistério', 'entrega', 'experiência'], tom: 'poético', profundidade: 4,
  ...
  {
    id: 'curated-22', editorialStatus: 'quarantine', autor: 'Blaise Pascal', frase: 'Grande parte da inquietação humana nasce da dificuldade de permanecer em silêncio consigo mesmo.',
  ...
  {
    id: 'curated-23', editorialStatus: 'quarantine', autor: 'Jean-Paul Sartre', frase: 'Somos responsáveis por nossas escolhas mesmo quando não escolhemos as circunstâncias em que precisamos agir.',
  ...
  },
  {
    ...
    sentimentos: ['raiva'], intensidade: ['moderada'], temas: ['potência', 'justiça', 'transformação'], tom: 'direto', profundidade: 4,
  ...
  {
    id: 'curated-26', editorialStatus: 'removed', autor: 'Schopenhauer', frase: 'Os homens são os demônios da terra, e os animais são as almas condenadas.',
  ...
  {
    id: 'curated-27', editorialStatus: 'quarantine', autor: 'Schopenhauer', frase: 'A nossa capacidade de amar é proporcional à nossa capacidade de ignorar os defeitos daqueles que amamos.',
  ...
  },
  {
    ...
    sentimentos: ['confusão'], intensidade: ['moderada'], temas: ['aparência', 'convivência', 'máscaras', 'indiretas'], tom: 'contemplativo', profundidade: 4,
  ...
  {
    id: 'curated-29', editorialStatus: 'quarantine', autor: 'Emil Cioran', frase: 'Conviver com as pessoas nos obriga a uma constante encenação, onde o papel mais difícil é fingir que nos importamos.',
  ...
  {
    id: 'curated-30', editorialStatus: 'quarantine', autor: 'Emil Cioran', frase: 'O que sei aos sessenta anos, já o sabia aos vinte. Quarenta anos de um longo e inútil trabalho de verificação.',
  ...
  {
    id: 'curated-31', editorialStatus: 'removed', autor: 'Emil Cioran', frase: 'A consciência é o tédio de existir que descobriu a palavra.',
  ...
  {
    id: 'curated-32', editorialStatus: 'quarantine', autor: 'Diógenes de Sinope', frase: 'O insulto não fere quando quem o profere não tem o respeito de quem o ouve.',
  ...
  {
    id: 'curated-33', editorialStatus: 'removed', autor: 'Diógenes de Sinope', frase: 'Dos animais selvagens, o caluniador; dos domésticos, o lisonjeiro.',
  ...
  {
    id: 'curated-34', editorialStatus: 'removed', autor: 'Diógenes de Sinope', frase: 'Tenho muitos amigos com quem compartilho o silêncio, porque quando eles abrem a boca, a amizade acaba.',
  ...
  {
    id: 'curated-35', editorialStatus: 'removed', autor: 'Diógenes de Sinope', frase: 'Prefiro um inimigo honesto que me morda de frente a um amigo falso que me lamba pelas costas.',
  ...
  {
    id: 'curated-36', editorialStatus: 'quarantine', autor: 'Baltasar Gracián', frase: 'Há quem gaste mais tempo fingindo que sabe do que os outros gastam para realmente aprender.',
  ...
  {
    id: 'curated-37', editorialStatus: 'quarantine', autor: 'Baltasar Gracián', frase: 'O maior erro de quem se acha esperto é acreditar que todo mundo ao redor é tolo.',
  ...
  {
    id: 'curated-39', editorialStatus: 'removed', autor: 'Baltasar Gracián', frase: 'Falar com quem não quer entender é como acender uma vela para um cego: o único que gasta energia é você.',
  ...
  {
    id: 'curated-40', editorialStatus: 'quarantine', autor: 'Baltasar Gracián', frase: 'Evite os que são amigos apenas da sua boa sorte; na primeira nuvem, eles desaparecem para não se molharem.',
  ...
  {
    id: 'curated-41', editorialStatus: 'removed', autor: 'Charles Bukowski', frase: 'Algumas pessoas nunca enlouquecem. Que vidas horríveis elas devem levar.',
  ...
  {
    id: 'curated-42', editorialStatus: 'removed', autor: 'Charles Bukowski', frase: 'O problema com o mundo é que as pessoas inteligentes estão cheias de dúvidas, enquanto as estúpidas estão cheias de certeza.',
  ...
  {
    id: 'curated-43', editorialStatus: 'quarantine', autor: 'Charles Bukowski', frase: 'Gosto de pessoas que não precisam de uma plateia para existir.',
  ...
  {
    id: 'curated-45', editorialStatus: 'quarantine', autor: 'Virginia Woolf', frase: 'O olhar dos outros é a nossa prisão; os pensamentos dos outros, a nossa cela.',
  ...
  {
    id: 'curated-101', editorialStatus: 'quarantine', autor: 'Rainer Maria Rilke', frase: 'Que a saudade não seja um fardo, mas uma forma de presença. Aqueles que amamos nunca vão embora, eles caminham ao nosso lado todos os dias.',
  ...
  {
    id: 'curated-102', editorialStatus: 'quarantine', autor: 'Pema Chödrön', frase: 'Quando o coração está partido, é o momento perfeito para deixar o amor fluir. A rachadura é por onde a luz entra, mas também por onde o amor que ficou pode sair e tocar o mundo.',
  ...
  {
    id: 'curated-103', editorialStatus: 'quarantine', autor: 'Thich Nhat Hanh', frase: 'A nuvem nunca morre. Ela se transforma em chuva, neve ou vapor, mas nunca deixa de ser. A pessoa que você ama também não morreu; ela apenas mudou de forma.',
  ...
  {
    id: 'curated-104', editorialStatus: 'quarantine', autor: 'Khalil Gibran', frase: 'Quando estiveres triste, olha de novo em teu coração, e verás que na verdade estás chorando por aquilo que foi o teu deleite. A dor é a taça que contém o vinho da alegria passada.',
  ...
  {
    id: 'curated-105', editorialStatus: 'quarantine', autor: 'C. S. Lewis', frase: 'A perda de um ente querido é uma amputação. A ferida cicatriza, mas a parte que falta nunca é esquecida. Aprende-se a viver sem ela, e isso já é uma forma de cura.',
  ...
  {
    id: 'curated-106', editorialStatus: 'quarantine', autor: 'Epicuro', frase: 'A morte não é nada para nós. Enquanto existimos, a morte não está presente. Quando a morte chega, somos nós que não estamos mais aqui. Por que temer o que nunca encontraremos?',
  ...
  {
    id: 'curated-107', editorialStatus: 'quarantine', autor: 'Clarice Lispector', frase: 'Saudade é um pouco como fome. Só passa quando se come a presença. Mas às vezes a saudade é tão profunda que a presença é pouca: queremos absorver a outra pessoa toda. Essa vontade de um ser o outro é o amor.',
  ...
  {
    id: 'curated-108', editorialStatus: 'quarantine', autor: 'Viktor Frankl', frase: 'O amor é a única maneira de capturar outro ser humano no mais íntimo de sua personalidade. Por seu amor, a pessoa que ama torna possível ao amado manifestar suas potencialidades. E, ao fazê-lo, o amor sobrevive até mesmo à morte.',
  ...
  {
    id: 'curated-109', editorialStatus: 'quarantine', autor: 'Sêneca', frase: 'Aquele a quem amas não está mais aqui? Mas ele está onde está. E se está em algum lugar, não está perdido. A morte é apenas o fim da jornada visível.',
  ...
  {
    id: 'curated-110', editorialStatus: 'quarantine', autor: 'Ramana Maharshi', frase: 'O que nasceu morrerá. O que nunca nasceu nunca morrerá. Você não é o corpo, você é a consciência que o testemunha. A pessoa que você ama é essa mesma consciência. Ela nunca morreu.',
  ...
  },
  {
    ...
    sentimentos: ['luto', 'saudade'], intensidade: ['moderada'], temas: ['silêncio', 'escuta interior', 'memória'], tom: 'poético', profundidade: 4,
  ...
  {
    id: 'curated-112', editorialStatus: 'quarantine', autor: 'Khalil Gibran', frase: 'Vosso amigo é a resposta a vossas necessidades. Ele é o campo que semeais com amor e colheis com gratidão. Quando ele se vai, o campo não se torna estéril; as sementes que ele plantou em vós continuam a dar frutos.',
  ...
  {
    id: 'curated-114', editorialStatus: 'quarantine', autor: 'Henry Scott Holland', frase: 'A morte não é nada. Eu apenas passei para o outro lado. Eu sou eu, vocês são vocês. O que éramos uns para os outros, continuamos a ser. A vida continua significando o que sempre significou. O fio não foi cortado.',
  ...
  {
    id: 'curated-115', editorialStatus: 'quarantine', autor: 'Anandamayi Ma', frase: 'Assim como uma pessoa que sonha não morre quando o sonho termina, aquele que parte deste mundo não morre, apenas desperta para outra realidade. A chama da vida nunca se apaga; ela muda de lamparina.',
